...
import net.neoforged.forgespi.language.IConfigurable;
import net.neoforged.forgespi.language.IModFileInfo;
import net.neoforged.forgespi.language.IModInfo;
import net.neoforged.forgespi.language.IModLanguageProvider;
import net.neoforged.forgespi.language.ModFileScanData;
import net.neoforged.forgespi.locating.ForgeFeature.Bound;
import net.neoforged.forgespi.locating.IModFile;
import net.neoforged.forgespi.locating.IModProvider;
