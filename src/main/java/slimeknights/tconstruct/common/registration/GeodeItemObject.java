...
public class GeodeItemObject extends ItemObject<Item> {
  ...
  public GeodeItemObject(ItemObject<Item> shard, BlockDeferredRegister register, MapColor color, SoundType blockSound, SoundEvent chimeSound, Map<BudSize,SoundType> clusterSounds, int baseLight, Properties props) {
    super(shard);
