...
public class ModifierArgument implements ArgumentType<Modifier> {
  ...
  public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
    return TinkerSuggestionProvider.suggestResource(TConstruct.MOD_ID, ModifierManager.INSTANCE.getAllValues(), builder, mod -> mod.getId().getLocation(), Modifier::getDisplayName);
  }
