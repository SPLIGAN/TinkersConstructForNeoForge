...
public class AntigravityEffect extends TinkerEffect {
  ...
  public AntigravityEffect() {
    ...
    this.addAttributeModifier(Attributes.GRAVITY, TConstruct.getResource("effect.antigravity_gravity"), -2, Operation.ADD_MULTIPLIED_TOTAL);
  ...
  public boolean applyEffectTick(LivingEntity living, int amplifier) {
    ...
    if (living.getAttributeValue(Attributes.GRAVITY) < 0) {
      ...
      if (living.onClimbable()) {
        ...
        if (living.horizontalCollision || living.getDeltaMovement().y > 0.1) {
          y = -0.2;
        }
