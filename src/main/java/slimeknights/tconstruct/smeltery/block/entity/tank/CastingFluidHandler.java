...
public class CastingFluidHandler implements IFluidHandler {
  ...
  public void readFromTag(CompoundTag nbt) {
    ...
    if (nbt.contains(TAG_FLUID, Tag.TAG_COMPOUND)) {
      setFluid(FluidStack.parseOptional(ItemStackTagCompat.FALLBACK_REGISTRY, nbt.getCompound(TAG_FLUID)));
    }
  ...
  public CompoundTag writeToTag(CompoundTag nbt) {
    ...
    if (!fluid.isEmpty()) {
      nbt.put(TAG_FLUID, fluid.save(ItemStackTagCompat.FALLBACK_REGISTRY));
    }
