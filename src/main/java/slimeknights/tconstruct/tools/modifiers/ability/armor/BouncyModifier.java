...
public class BouncyModifier extends NoLevelsModifier {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(AttributeModule.builder(TinkerAttributes.BOUNCY.get(), Operation.ADD_VALUE).uniqueFrom(getId().getLocation()).tooltipStyle(TooltipStyle.NONE).flat(1));
  }
}
