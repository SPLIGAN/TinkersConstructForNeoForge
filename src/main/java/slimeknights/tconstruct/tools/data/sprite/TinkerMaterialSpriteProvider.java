  ...
  protected void addAllMaterials() {
    ...
    buildMaterial(MaterialIds.ice)
      ...
      .transformer(GreyToSpriteTransformer.builderFromBlack()
        .addTexture(63, ResourceLocation.withDefaultNamespace("block/blue_ice"))
        .addTexture(102, ResourceLocation.withDefaultNamespace("block/packed_ice"))
        .addTexture(140, ResourceLocation.withDefaultNamespace("block/ice"))
        .build());
...
//    buildMaterial(MaterialIds.uranium).fallbacks("metal").colorMapper(uraniumPalette);
    ...
    for (DyeColor color : DyeColor.values()) {
      ...
      builder.arrowHead().transformer(transformerFromSprite(ResourceLocation.withDefaultNamespace("block/" + name + "_wool"), 0, 0));
