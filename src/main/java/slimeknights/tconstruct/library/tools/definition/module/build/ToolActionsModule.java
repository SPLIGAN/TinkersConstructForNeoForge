...
public record ToolActionsModule(Set<ItemAbility> actions) implements ToolActionToolHook, ToolModule {
  ...
  public static final RecordLoadable<ToolActionsModule> LOADER = RecordLoadable.create(TinkerLoadables.ITEM_ABILITY.set().requiredField("tool_actions", ToolActionsModule::actions), ToolActionsModule::new);
