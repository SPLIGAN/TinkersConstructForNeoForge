...
public class ToolPartLootEntry extends LootPoolSingletonContainer {
  public static final MapCodec<ToolPartLootEntry> CODEC = MapCodec.unit(new ToolPartLootEntry(ItemTags.PLANKS, RandomMaterial.firstWithStat(), 1, 0, List.of(), List.of()));
