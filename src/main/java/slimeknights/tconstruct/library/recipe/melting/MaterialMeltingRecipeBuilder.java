...
public class MaterialMeltingRecipeBuilder extends AbstractRecipeBuilder<MaterialMeltingRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer) {
    save(consumer, inputId.getId().getLocation());
  }

  @Override
  public void save(RecipeOutput consumer, ResourceLocation id) {
    consumer.accept(id, new MaterialMeltingRecipe(id, inputId, temperature, result, byproducts), this.buildOptionalAdvancementHolder(consumer, id, "melting"));
  }
}
