...
public class MaterialSwappingRecipeBuilder extends AbstractRecipeBuilder<MaterialSwappingRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    if (part != null) {
      ...
      consumer.accept(id, new PartSwappingOverrideRecipe(id, tools, maxStackSize, part, indices), null);
    } else {
      consumer.accept(id, new FixedMaterialSwappingRecipe(id, tools, maxStackSize, ingredient, material, indices, repairValue), null);
    }
  }
}
