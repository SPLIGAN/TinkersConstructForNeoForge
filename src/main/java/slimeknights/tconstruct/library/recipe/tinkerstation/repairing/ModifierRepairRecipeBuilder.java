...
public class ModifierRepairRecipeBuilder extends AbstractRecipeBuilder<ModifierRepairRecipeBuilder> {
  ...
  public ModifierRepairRecipeBuilder buildCraftingTable(RecipeOutput consumer, ResourceLocation id) {
    consumer.accept(id, new ModifierRepairCraftingRecipe(id, modifier, ingredient, repairAmount), buildOptionalAdvancementHolder(consumer, id, "tinker_station"));
    return this;
  }

  @Override
  public void save(RecipeOutput consumer, ResourceLocation id) {
    consumer.accept(id, new ModifierRepairTinkerStationRecipe(id, modifier, ingredient, repairAmount), buildOptionalAdvancementHolder(consumer, id, "tinker_station"));
  }
}
