...
public class OverslimeModifierRecipeBuilder extends AbstractRecipeBuilder<OverslimeModifierRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    consumer.accept(id, new OverslimeModifierRecipe(id, tools, ingredient, restoreAmount), buildOptionalAdvancementHolder(consumer, id, "modifiers"));
  }
  ...
  public OverslimeModifierRecipeBuilder saveCrafting(RecipeOutput consumer, ResourceLocation id) {
    ...
    consumer.accept(id, new OverslimeCraftingTableRecipe(id, tools, ingredient, restoreAmount), buildOptionalAdvancementHolder(consumer, id, "modifiers"));
    return this;
  }
}
