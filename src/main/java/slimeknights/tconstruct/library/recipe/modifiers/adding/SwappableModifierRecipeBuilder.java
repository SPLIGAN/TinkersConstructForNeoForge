...
public class SwappableModifierRecipeBuilder extends ModifierRecipeBuilder {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    consumer.accept(id, new SwappableModifierRecipe(id, inputs, tools, maxToolSize, result, value, variantFormatter, slots, allowCrystal), buildOptionalAdvancementHolder(consumer, id, "modifiers"));
  }
}
