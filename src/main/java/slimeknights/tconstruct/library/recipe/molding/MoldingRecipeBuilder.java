...
public class MoldingRecipeBuilder extends AbstractRecipeBuilder<MoldingRecipeBuilder> {
  ...
  public static MoldingRecipeBuilder moldingTable(ItemLike item) {
    return molding(ItemOutput.fromItem(item), (TypeAwareRecipeSerializer<MoldingRecipe>) TinkerSmeltery.moldingTableSerializer.get());
  }
  ...
  public static MoldingRecipeBuilder moldingBasin(ItemLike item) {
    return molding(ItemOutput.fromItem(item), (TypeAwareRecipeSerializer<MoldingRecipe>) TinkerSmeltery.moldingBasinSerializer.get());
  }
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    consumer.accept(id, new MoldingRecipe(serializer, id, material, pattern, patternConsumed, output), buildOptionalAdvancementHolder(consumer, id, "molding"));
  }
