...
public class MaterialRecipeBuilder extends AbstractRecipeBuilder<MaterialRecipeBuilder> {
  ...
  public void save(RecipeOutput consumerIn, ResourceLocation id) {
    ...
    consumerIn.accept(id, new MaterialRecipe(id, group, ingredient, value, needed, material, leftover), this.buildOptionalAdvancementHolder(consumerIn, id, "materials"));
  }
}
