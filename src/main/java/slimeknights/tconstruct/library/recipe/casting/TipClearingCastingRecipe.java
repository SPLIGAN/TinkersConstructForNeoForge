...
public class TipClearingCastingRecipe extends PotionCastingRecipe {
  private static final LoadableField<String, TipClearingCastingRecipe> GROUP_FIELD = StringLoadable.DEFAULT.defaultField("group", "", TipClearingCastingRecipe::getGroup);
  public static final RecordLoadable<TipClearingCastingRecipe> LOADER = RecordLoadable.withLoader(
    ...
    (id, group, tool, fluid, coolingTime, modifier, loader) -> new TipClearingCastingRecipe((TypeAwareRecipeSerializer<?>) loader, id, group, tool, fluid, coolingTime, modifier));
